      ...
      <ul class="app-menu">
       ...
       <li class="has-submenu">
          <a href="javascript:void(0)" class="submenu-toggle">
            ...
            <span class="menu-text">Slot Booking</span>
            <i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>
          </a>
          <ul class="submenu">
            <li><a href="new-appointment.php"><span class="menu-text">New Slot Details</span></a></li>
            <li><a href="approved-appointment.php"><span class="menu-text">Approved Slot</span></a></li>
            <li><a href="cancelled-appointment.php"><span class="menu-text">Cancelled Slot</span></a></li>
            <li><a href="all-appointment.php"><span class="menu-text">All Slot Bookings</span></a></li>
