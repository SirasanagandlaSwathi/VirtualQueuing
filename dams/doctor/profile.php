...
<head>
  ...
  <title>RSMS - Doctor Profile</title>
      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title">RATION SHOP PROFILE
			</h3>
...
{               ?>
            <form class="form-horizontal" method="post">
              <div class="form-group">
                <label for="exampleTextInput1" class="col-sm-3 control-label">RATION SHOP ID:</label>
                <div class="col-sm-9">
              ...
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">DISTRICT:</label>
                <div class="col-sm-9">
